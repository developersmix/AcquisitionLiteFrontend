...
@Component({
  selector: 'app-requisition-recieve',
  templateUrl: './requisition-recieve.component.html',
  styleUrls: ['./requisition-recieve.component.scss']
})
export class RequisitionRecieveComponent implements OnInit {
